      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            <h3 className="font-bold text-gray-900" style={{ fontFamily: "'Playfair Display', serif" }}>Información de contacto</h3>
            {completedSections.includes(1) && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pl-10  border-2 border-gray-300 focus:border-[#3A6EA5] focus:ring-2 focus:ring-[#3A6EA5]/20 outline-none transition-all"
                      required
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3  border-2 border-gray-300 focus:border-[#3A6EA5] focus:ring-2 focus:ring-[#3A6EA5]/20 outline-none transition-all"
                    required
                  />
                </div>
              </div>
